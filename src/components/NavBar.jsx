...
// setting up the navbar and its stateS
const NavBar = () => {
    ...
    return (
        <header className='w-full fixed z-10 bg-black opacity-90'>
            <nav className='flex w-full py-2 md:py-3 px-4 md:px-20 items-center justify-between'>
                ...
                <u1 className='hidden md:flex text-white gap-6'>
                    <li>
                        <a href='/'>Home</a>
                    </li>
                    <li>
                ...
                <Button 
                title='Sign in'
                containerStyle='hidden md:block bg-transparent border border-white tex-white hover:bg-white hover:text-slate-700 rounded-full min-w-[130px]'/>
